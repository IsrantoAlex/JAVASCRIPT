document.addEventListener('DOMContentLoaded', () => {
    ...
    numberButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            userGuessDiv.textContent = `User  ${userGuess}`;
        });
    });
    ...
    enterBtn.addEventListener('click', () => {
        ...
        computerGuessDiv.textContent = `Computer  ${computerGuess}`;
    ...
    function resetGame() {
        userGuess = null;
        userGuessDiv.textContent = 'User  ';
        computerGuessDiv.textContent = 'Computer  ';
